const SocialLinks = ({ className = "" }) => {
  const socialLinks = [
    {
      name: "GitHub",
      url: "https://github.com/SagarBarate",
      icon: (
    ...
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/sagar-barate-6b22041b3",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "LeetCode",
      url: "https://leetcode.com/u/Sagarbarate/",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "HackerRank",
      url: "https://www.hackerrank.com/profile/sagarbarate2907",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
