          ...
          <div className="glass scroll-card p-8 md:p-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              ...
              <div className="flex justify-center md:justify-start">
                <div className="w-full max-w-md h-96 rounded-lg border-4 border-ninja-orange overflow-hidden bg-gray-100">
                  <img
                    src="https://via.placeholder.com/500x600?text=Your+Photo+PNG"
                    alt="Profile"
              ...
              <div className="flex-1">
                <h1 className="text-4xl md:text-5xl font-bold mb-6 ninja-text text-ninja-orange">
                  About Me
                </h1>
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="flex gap-4 justify-center">
                  <a
                    ...
                    className="p-2 border-2 border-ninja-orange rounded-full hover:bg-ninja-orange hover:text-white transition-colors"
                  >
